...
<image src="/telegramm_start.jpg" alt="Установка «Бота-помощника»"><i>Рисунок 5. Установка «Бота-помощника»</i>
<br><br>
На экране появится сообщение, о готовности к работе «Бота-помощника».
<image src="/Bot_ready.jpg" alt="«Бот-помощник» готов к работе"><i>Рисунок 6. «Бот-помощник» готов к работе</i>
<br><br>
...
<image src="/telegramm_request.jpg" alt="Рисунок 7. Поле ввода запроса"><i>Рисунок 7. Поле ввода запроса</i>

...
<image src="/image_and_history_city/telegramm_result.jpg" width="400" height="790" alt="Рисунок 8. Результаты работы «Бота-помощника»"><i>Рисунок 8. Результаты работы «Бота-помощника»</i>
<br><br>

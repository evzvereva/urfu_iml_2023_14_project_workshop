...
1. Установка API осуществляется с помощью Dockerfile, подробное описание процесса установки можно посмотреть перейдя по [ссылка](/backend_api/README.md)(см. раздел «Установка»)  

...
Для использования чат-бота в телеграмме потребуется сначала его установить. В интернет браузере на мобильном телефоне или планшете требуется перейти по следующей ссылке [ссылке](https://t.me/PP14CityGuideBot) и нажать на кнопку «СТАРТ» (выделена прямоугольником зеленого цвета).   
